...
CMFChw2Dlg::CMFChw2Dlg(CWnd* pParent /*=nullptr*/)
	: CDialogEx(IDD_MFC_HW2_DIALOG, pParent)
...
BEGIN_MESSAGE_MAP(CMFChw2Dlg, CDialogEx)
	...
	ON_WM_PAINT()
	ON_WM_QUERYDRAGICON()
	ON_BN_CLICKED(IDOK, &CMFChw2Dlg::OnBnClickedOk)
	ON_STN_CLICKED(IDC_TEXT, &CMFChw2Dlg::OnStnClickedText)
END_MESSAGE_MAP()
...
void CMFChw2Dlg::OnStnClickedText()
{
	// TODO: 在此添加控件通知处理程序代码
}
