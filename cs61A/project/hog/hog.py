...
def max_scoring_num_rolls(dice=six_sided, samples_count=1000):
    ...
    """
    # BEGIN PROBLEM 9
    max_rollings, max_score = 0, 0
    rolling = make_averaged(roll_dice, samples_count)
    for dice_num in range(1, 11):
        score = rolling(dice_num, dice)
        if score > max_score:
            max_rollings = dice_num
            max_score = score
